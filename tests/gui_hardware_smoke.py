#!/usr/bin/env python3
"""Manual IMX296/Hailo/embedded-video startup and clean-shutdown smoke test."""
...
def main():
    ...
    def start_camera():
        if "SMOKE_THRESHOLD" in os.environ:
            window.threshold_scale.set_value(float(os.environ["SMOKE_THRESHOLD"]))
    ...
    GLib.timeout_add(500, start_camera)
